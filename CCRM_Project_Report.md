...
Outside scope: persistence to disk or database, a graphical or web interface, authentication, concurrent access, and attendance tracking. These are discussed in Section 10 as candidates for a
